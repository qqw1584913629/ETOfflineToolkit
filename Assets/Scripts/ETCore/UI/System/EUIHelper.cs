...
namespace MH
{
    public static class EUIHelper
    {
        ...
        public static void InitOptions(this TMP_Dropdown dropdown, List<string> lists)
        {
            dropdown.ClearOptions();
            dropdown.AddOptions(lists);
        }
        public static void AddListener(this TMP_Dropdown dropdown, UnityAction<int> clickEventHandler)
        {
            ...
            // dropdown.onClick.RemoveAllListeners();
            // button.onClick.AddListener(() =>
            // {
            //     Init.Instance.Root.GetComponent<AudioComponent>().PlaySoundEffect(ClipID.ButtonClickClip);
            //     clickEventHandler();
            // });
        }

        public static void OnEndEdit(this TMP_InputField inputField, UnityAction<string> clickEventHandler)
        {
            inputField.onEndEdit.RemoveAllListeners();
            inputField.onEndEdit.AddListener((string i) =>
            {
                clickEventHandler(i);
            });
        }
        public static void OnSubmit(this TMP_InputField inputField, UnityAction<string> clickEventHandler)
        {
            inputField.onSubmit.RemoveAllListeners();
            inputField.onSubmit.AddListener((string i) =>
            {
                clickEventHandler(i);
            });
        }
        public static void AddListener(this TMP_InputField inputField, UnityAction<string> clickEventHandler)
        {
            inputField.onValueChanged.RemoveAllListeners();
            inputField.onValueChanged.AddListener((string i) =>
            {
                clickEventHandler(i);
            });
        }
