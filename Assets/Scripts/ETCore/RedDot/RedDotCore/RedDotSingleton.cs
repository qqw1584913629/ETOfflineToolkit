...
namespace MH
{
    public class RedDotSingleton : LogicSingleton<RedDotSingleton>, ISingletonAwake
    {
        ...
        public RedDotConfigAsset Config;
        public void Awake()
        { 
            Config = ResourceSingleton.Instance.LoadAssetSync<RedDotConfigAsset>(nameof(RedDotConfigAsset));;
            InitRedDotTreeNode();
        }
        public void InitRedDotTreeNode()
        {
            // 创建所有节点
            foreach (var config in Config.AllRedDotConfigList)
            {
