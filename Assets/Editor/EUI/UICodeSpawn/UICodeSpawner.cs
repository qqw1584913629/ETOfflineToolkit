...
public partial class UICodeSpawner
{
    ...
    public static void CreateWindowItemReseCode(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/ET/UI/WindowItemRes.cs";
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + "/Scripts/UI/HotfixView/UICode/" + strDlgName;
        ...
        strFilePath = Application.dataPath + "/Scripts/UI/HotfixView/UICode/" + strDlgName + "/" + strDlgName + "System.cs";
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + "/Scripts/ETCore/UI/WindowId.cs";
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + "/Scripts/UI/HotfixView/UICode/" + strDlgName + "/Event";
        ...
        strFilePath = Application.dataPath + "/Scripts/UI/HotfixView/UICode/" + strDlgName + "/Event/" + strDlgName + "EventHandler.cs";
        if (System.IO.File.Exists(strFilePath))
        {
    ...
    {
        string strDlgName = gameObject.name;
        string strFilePath = Application.dataPath + "/Scripts/UI/ModelView/UICode/" + strDlgName;
        ...
        strFilePath = Application.dataPath + "/Scripts/UI/ModelView/UICode/" + strDlgName + "/" + strDlgName + ".cs";
        if (System.IO.File.Exists(strFilePath))
        {
            Debug.LogError("已存在 " + strDlgName + ".cs,将不会再次生成。");
            return;
    ...
    static void SpawnCodeForDlgBehaviour(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/UI/HotfixView/UIBehaviour/" + strDlgName;

        if (!System.IO.Directory.Exists(strFilePath))
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath = Application.dataPath + "/Scripts/UI/HotfixView/UIBehaviour/" + strDlgName + "/" + strDlgComponentName + "System.cs";
    ...
    static void SpawnCodeForDlgComponentBehaviour(GameObject gameObject)
    {
        ...
        string strFilePath = Application.dataPath + "/Scripts/UI/ModelView/UIBehaviour/" + strDlgName;
        if (!System.IO.Directory.Exists(strFilePath))
        {
            System.IO.Directory.CreateDirectory(strFilePath);
        }
        strFilePath = Application.dataPath + "/Scripts/UI/ModelView/UIBehaviour/" + strDlgName + "/" + strDlgComponentName + ".cs";
        StreamWriter sw = new StreamWriter(strFilePath, false, Encoding.UTF8);
        StringBuilder strBuilder = new StringBuilder();
        strBuilder.AppendLine()
            .AppendLine("using UnityEngine;");
